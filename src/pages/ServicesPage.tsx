...
export default function ServicesPage() {
  useSEO({ title: 'IT Services & Digital Solutions | Vypax Technologies', description: 'Web development, digital marketing, SEO, Google Business Profile optimization, data analysis and data science, and custom software solutions in Roorkee.', keywords: 'IT services Uttarakhand, web development Haridwar, digital marketing Roorkee, SEO services India, custom software development, data analysis services, business growth solutions' });
  return <>
