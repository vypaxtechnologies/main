...
export default function JobsPage() {
	useSEO({ title: 'Jobs | Vypax Technologies', description: 'Build your future with Vypax Technologies. We are building a team that loves technology, creativity and meaningful business impact.' });
		...
		<>
			<section className="pt-32 pb-12 md:pt-40">
				<div className="container-x">
					<Breadcrumbs items={[{ label: 'Home', path: '/' }, { label: 'Jobs' }]} />
