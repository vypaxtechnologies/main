...
const floatingCards = [
  { icon: BarChart3, label: 'Cloud', className: 'left-[-1rem] top-8', delay: 0 },
  { icon: Zap, label: 'Analytics', className: 'right-[-1rem] top-20', delay: 0.5 },
  { icon: BarChart3, label: 'Mobile', className: 'left-[2rem] bottom-12', delay: 1 },
  { icon: Zap, label: 'Database', className: 'right-[3rem] bottom-8', delay: 1.5 },
];
...
export default function Hero() {
  return (
    <section className="relative overflow-hidden pt-32 pb-20 md:pt-40 md:pb-28">
      ...
      <div
        className="blob left-[-10%] top-[-5%] h-96 w-96 bg-brand-blue"
        style={blobFloat}
      />
      <div
        className="blob right-[-5%] top-[20%] h-80 w-80 bg-brand-purple"
        style={blobFloat}
      />
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          <div className="relative">
            <div className="relative mx-auto max-w-md lg:max-w-lg">
              <div className="pointer-events-none absolute -inset-8 rounded-[36px] border border-brand-blue/20" />
              <div className="pointer-events-none absolute -inset-3 rounded-[32px] border border-brand-cyan/20 [transform:rotate(18deg)]" />
